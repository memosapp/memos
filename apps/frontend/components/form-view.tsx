...
export function FormView({ settings, onChange }: FormViewProps) {
  ...
  const handleMemosChange = (key: string, value: any) => {
    onChange({
      ...settings,
      openmemory: {
        ...settings.openmemory,
  ...
  const needsLlmApiKey =
    settings.mem0?.llm?.provider?.toLowerCase() !== "ollama";
  const needsEmbedderApiKey =
    settings.mem0?.embedder?.provider?.toLowerCase() !== "ollama";
  const isLlmOllama = settings.mem0?.llm?.provider?.toLowerCase() === "ollama";
  const isEmbedderOllama =
    settings.mem0?.embedder?.provider?.toLowerCase() === "ollama";
  ...
  return (
    <div className="space-y-8">
      ...
      <Card>
        <CardHeader>
          <CardTitle>Memos Settings</CardTitle>
          <CardDescription>
            Configure your Memos instance settings
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          <div className="space-y-2">
            ...
            <Textarea
              ...
              onChange={(e) =>
                handleMemosChange("custom_instructions", e.target.value)
              }
        ...
        <CardContent className="space-y-6">
          ...
          {isLlmOllama && (
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  handleLlmConfigChange("ollama_base_url", e.target.value)
                }
              />
              <p className="text-xs text-muted-foreground mt-1">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  onChange={(e) =>
                    handleLlmConfigChange("api_key", e.target.value)
                  }
                />
                <Button
                  variant="ghost"
              ...
              <p className="text-xs text-muted-foreground mt-1">
                Use "env:API_KEY" to load from environment variable, or enter
                directly
              </p>
            </div>
          )}
          ...
          <div className="flex items-center space-x-2 pt-2">
            <Switch
              ...
              checked={showLlmAdvanced}
              onCheckedChange={setShowLlmAdvanced}
            />
            <Label htmlFor="llm-advanced-settings">
              ...
              <div className="space-y-2">
                <div className="flex justify-between">
                  <Label htmlFor="temperature">
                    Temperature: {settings.mem0?.llm?.config?.temperature}
                  </Label>
                </div>
                <Slider
                  id="temperature"
                  ...
                  onValueChange={(value) =>
                    handleLlmConfigChange("temperature", value[0])
                  }
                />
              </div>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Configure your Embedding Model provider and settings
          </CardDescription>
        </CardHeader>
        <CardContent className="space-y-6">
          <div className="space-y-2">
          ...
          <div className="space-y-2">
            ...
            <Input
              ...
              onChange={(e) =>
                handleEmbedderConfigChange("model", e.target.value)
              }
            />
          </div>
          ...
          {isEmbedderOllama && (
            <div className="space-y-2">
              ...
              <Input
                ...
                onChange={(e) =>
                  handleEmbedderConfigChange("ollama_base_url", e.target.value)
                }
              />
              <p className="text-xs text-muted-foreground mt-1">
                Leave empty to use default: http://host.docker.internal:11434
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  onChange={(e) =>
                    handleEmbedderConfigChange("api_key", e.target.value)
                  }
                />
                <Button
                  variant="ghost"
